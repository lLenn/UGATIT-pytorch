...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default=1, help='The number of log progress freq')
    ...
    parser.add_argument('--data_dir', type=str, default='data', help='Directory name to get the data')
